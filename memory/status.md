...
| **Medição rollout 5% — tag `[ESTADO:]` esquecida** | 🟡 Pré-rollout v2 | Após smoke OK + ligar `AGENT_VERSION=v2` em 5%: instrumentar log em replyV2 quando `parsed.stateFields === null`. Janela: **50 conversas reais OU 14 dias corridos**, o que vier primeiro. Critérios: <10% aceita como known issue, 10-20% prioriza Fase 6, >20% abre re-arquitetura com tool use estruturado como Fase 6 prioritária. |
